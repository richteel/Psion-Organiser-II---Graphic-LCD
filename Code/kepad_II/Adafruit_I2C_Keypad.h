#ifndef _Adafruit_I2C_Keypad_H_
#define _Adafruit_I2C_Keypad_H_
...
*/
/**************************************************************************/
class Adafruit_I2C_Keypad {
public:
  Adafruit_I2C_Keypad(byte *userKeymap, uint8_t rowPort, uint8_t colPort, int numRows,
